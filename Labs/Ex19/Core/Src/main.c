...
osThreadId AlarmingHandle;
osMessageQId QS2AHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_AlarmingTask */
/**
* @brief Function implementing the Alarming thread.
* @param argument: Not used
* @retval None
*/
