...
osThreadId LedFlashingHandle;
osMessageQId QS2RHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_LedFlashingTask */
/**
* @brief Function implementing the LedFlashing thread.
* @param argument: Not used
* @retval None
*/
